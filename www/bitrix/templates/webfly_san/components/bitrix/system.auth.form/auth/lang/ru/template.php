...
$MESS["WF_LOGIN_SITE"] = "Вход на сайт";
$MESS["WF_LOGIN_ORDER_HISTORY"] = "История заказов";
$MESS["WF_LOGIN_USER_PROFILES"] = "Профили покупателя";
$MESS["WF_LOGIN_USER_SETTINGS"] = "Настройки пользователя";
$MESS["WF_LOGIN_USER_SUBSCRIBE"] = "Настройки рассылок";
?>