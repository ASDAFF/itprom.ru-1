...
//if($arResult["FORM_TYPE"] == "login")
    ...
    <form action="<?= $arResult["AUTH_URL"] ?>">
      ...
      <? endforeach ?>
        ...
        <a href="#" class="btn-close-type01">&nbsp;</a>
        <ul>
          <li><a href="<?=SITE_DIR?>personal/order/"><?=GetMessage("WF_LOGIN_ORDER_HISTORY")?></a></li>
          <li><a href="<?=SITE_DIR?>personal/profile/"><?=GetMessage("WF_LOGIN_USER_PROFILES")?></a></li>
          <li><a href="<?=SITE_DIR?>personal/"><?=GetMessage("WF_LOGIN_USER_SETTINGS")?></a></li>
          <li><a href="<?=SITE_DIR?>personal/subscribe/"><?=GetMessage("WF_LOGIN_USER_SUBSCRIBE")?></a></li>
        </ul>
