...
if (!empty($arResult['ITEMS'])){
    ...
    if (strtolower($arItem["PROPERTIES"]["BRAND_REF"]["VALUE"]) != strtolower($arParams["BRAND_REF_VALUE"])){
  ...
  foreach($arResult["ITEMS"] as $key => $arItem){
    $arResult["ITEMS"][$key]["PREVIEW_PICTURE_SM"] = CFile::ResizeImageGet($arItem["PREVIEW_PICTURE"]["ID"], array('width'=>125, 'height'=>110), 
