...
class CExportproProfile{
    ...
    public function GetIBlockTreeShowType( $lid, $catalogOnly = true, $hideOffers = true, $subsection = false ){
        ...
        foreach( $arIblockTypes as $iblockTypeIndex => $arIblockTypeData ){
            foreach( $arIblockTypeData["IBLOCK"] as $iblockIndex => $iblockName ){
                ...
                $arIblockTypes[$iblockTypeIndex]["IBLOCK"][$iblockIndex]["SECTIONS"] = self::GetSections( array( $iblockIndex ), $subsection );
            }
        }
