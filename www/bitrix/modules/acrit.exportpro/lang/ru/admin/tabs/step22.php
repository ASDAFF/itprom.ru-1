...
$MESS["ACRIT_EXPORTPRO_SCHEME_EXPORT_IBLOCK_FIELDS_INSTEAD_CATEGORY_FIELDS"]="Экспортировать поля инфоблока корневых категорий";
$MESS["ACRIT_EXPORTPRO_SCHEME_EXPORT_IBLOCK_FIELDS_INSTEAD_CATEGORY_FIELDS_HELP"]="Определяет экспорт полей инфоблока для корневых категорий";
?>
