...
$profileTypes["lengow"] = array(
	...
	"FIELDS" => array(
        ...
        array(
			"CODE" => "DELIVERY_TIME",
			"NAME" => GetMessage( "ACRIT_EXPORTPRO_LENGOW_FIELD_DELIVERY_TIME" ),
		),
        array(
			"CODE" => "DELIVERY_DESCRIPTION",
			"NAME" => GetMessage( "ACRIT_EXPORTPRO_LENGOW_FIELD_DELIVERY_DESCRIPTION" ),
		),
        array(
		...
		array(
			"CODE" => "AVAILABILITY",
			"NAME" => GetMessage( "ACRIT_EXPORTPRO_LENGOW_FIELD_AVAILABILITY" ),
			"VALUE" => "",
            "TYPE" => "const",
            "CONDITION" => array(
                "CLASS_ID" => "CondGroup",
