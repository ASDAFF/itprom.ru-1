...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH . "/ibexp/ru/sanoffers.xml";
$iblockCode = "santech_offers"; //_".WIZARD_SITE_ID;
$iblockType = "offers";
...
if ($iblockID == false) {
  ...
  $iblockID = WizardServices::ImportIBlockFromXML(
                  $iblockXMLFile, $iblockCode, $iblockType, WIZARD_SITE_ID, $permissions
  );
  $iblock = new CIBlock;
	$arFields = Array(
		"ACTIVE" => "Y",
  ...
  if ($iblockID < 1) {
    $_SESSION["WF_SETUP_ERRORS"][] = "Failed to export offers IB!";
    return;
  }
}else{
  $arSites = array();
