...
if (\Bitrix\Main\ModuleManager::isModuleInstalled("highloadblock"))
{
    ...
    $arTemplateParameters['DETAIL_BRAND_WIDTH'] = array(
			'PARENT' => 'VISUAL',
			"NAME" => GetMessage("WF_DETAIL_BRAND_WIDTH"),
			"TYPE" => "STRING",
			"DEFAULT" => 120
		);
    $arTemplateParameters['DETAIL_BRAND_HEIGHT'] = array(
			'PARENT' => 'VISUAL',
			"NAME" => GetMessage("WF_DETAIL_BRAND_HEIGHT"),
			"TYPE" => "STRING",
			"DEFAULT" => 50
		);
    $arTemplateParameters['DETAIL_BRAND_WIDTH_SMALL'] = array(
			'PARENT' => 'VISUAL',
			"NAME" => GetMessage("WF_DETAIL_BRAND_WIDTH_SMALL"),
			"TYPE" => "STRING",
			"DEFAULT" => 90
		);
    $arTemplateParameters['DETAIL_BRAND_HEIGHT_SMALL'] = array(
			'PARENT' => 'VISUAL',
			"NAME" => GetMessage("WF_DETAIL_BRAND_HEIGHT_SMALL"),
			"TYPE" => "STRING",
			"DEFAULT" => 38
		);
	}
