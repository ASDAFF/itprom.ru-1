...
<div class="heading-blog">
  <h2 class="title-type04"><?=GetMessage("WF_COMPANY_NEWS")?></h2>
  <a href="<?=SITE_DIR?>blog/" class="heading-link"><?=GetMessage("WF_READ_NEWS")?></a>
  <div class="clearfix"></div>
 <!-- <?$APPLICATION->IncludeComponent("bitrix:main.include", "", Array("AREA_FILE_SHOW" => "file", "PATH" => SITE_DIR."include/blog_small_share.php"));?> -->
</div>
<ul class="blog-list">
