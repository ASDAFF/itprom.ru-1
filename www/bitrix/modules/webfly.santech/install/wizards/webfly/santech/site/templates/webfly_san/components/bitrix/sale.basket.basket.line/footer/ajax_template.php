...
?>
<span id="addCart" class="add-block"><?=GetMessage("TSB1_ADDED")?></span>
<div class="bx_small_cart">
	<a id="bs-link" href="<?=$arParams['PATH_TO_BASKET']?>"><?=GetMessage('TSB1_CART')?>:</a>
	<?if ($arParams['SHOW_NUM_PRODUCTS'] == 'Y' && ($arResult['NUM_PRODUCTS'] > 0 || $arParams['SHOW_EMPTY_VALUES'] == 'Y')):?>
		<span class="text basket-count"><?=$arResult['NUM_PRODUCTS']?></span>
	<?endif?>
  <?if ($arResult['NUM_PRODUCTS'] == 0):?>
    <span class="text" style="text-transform:uppercase;"><?=GetMessage("TSB1_EMPTY")?></span>
  <?endif;?>
  <div class="basket-info" style="<?=($arResult['NUM_PRODUCTS'] > 0?"display:block;":"")?>">
    <span class="item"><?=$arResult['PRODUCT(S)']?></span>
	<?if ($arParams['SHOW_TOTAL_PRICE'] == 'Y'):?>
     - 
		<?if ($arResult['NUM_PRODUCTS'] > 0 || $arParams['SHOW_EMPTY_VALUES'] == 'Y'):?>
			<span class="price"><?=str_replace(array(GetMessage("TSB1_ROUBLES"),".00"),"",$arResult['TOTAL_PRICE'])?></span>
