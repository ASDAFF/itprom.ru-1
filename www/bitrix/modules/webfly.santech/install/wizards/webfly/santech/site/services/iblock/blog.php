...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/ibexp/ru/sanblog.xml";
$iblockCode = "blog";//_".WIZARD_SITE_ID;
$iblockType = "content";
...
//public_files
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/blog/index.php", array("WF_IB_BLOG" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."_index.php", array("WF_IB_BLOG" => $iblockID));
//template_files
CWizardUtil::ReplaceMacros($_SERVER["DOCUMENT_ROOT"]."/bitrix/templates/webfly_san/components/bitrix/news/novosti/detail.php", array("WF_IB_BLOG" => $iblockID));
CWizardUtil::ReplaceMacros($_SERVER["DOCUMENT_ROOT"]."/bitrix/templates/webfly_san/components/bitrix/news/novosti/news.php", array("WF_IB_BLOG" => $iblockID));
?>
