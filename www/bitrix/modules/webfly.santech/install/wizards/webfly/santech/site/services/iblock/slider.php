...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/ibexp/ru/sanslide.xml";
$iblockCode = "slider";//_".WIZARD_SITE_ID;
$iblockType = "content";
...
//public
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."_index.php", array("WF_IB_SLIDER" => $iblockID)); 
?>
