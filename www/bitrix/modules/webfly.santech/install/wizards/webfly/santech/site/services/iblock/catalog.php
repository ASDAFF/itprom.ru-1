...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/ibexp/ru/sancat.xml";
$iblockCode = "santech";//_".WIZARD_SITE_ID;
$iblockType = "catalog";
...
//public_files
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/catalog/index.php", array("WF_IB_CATALOG" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/favorites/index.php", array("WF_IB_CATALOG" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."_index.php", array("WF_IB_CATALOG" => $iblockID)); 
//templates files
CWizardUtil::ReplaceMacros($_SERVER["DOCUMENT_ROOT"]."/bitrix/templates/webfly_san/components/bitrix/highloadblock.view/brand/template.php", array("WF_IB_CATALOG" => $iblockID));
?>
