...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/ibexp/ru/sanabout.xml";
$iblockCode = "help";//
$iblockType = "company";
...
//public
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/about/index.php", array("WF_IB_COMPANY" => $iblockID)); 
?>
