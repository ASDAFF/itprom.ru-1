...
COption::SetOptionString("bitlate.toolsshop", "NL_MAIN_ACTIONS_ID", $iblockID, false, WIZARD_SITE_ID);
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/main_banner.php", array("NL_ACTIONS_IBLOCK_ID" => $iblockID));
