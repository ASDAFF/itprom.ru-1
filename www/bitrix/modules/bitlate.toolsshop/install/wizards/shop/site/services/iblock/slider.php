...
COption::SetOptionString("bitlate.toolsshop", "NL_MAIN_SLIDER_ID", $iblockID, false, WIZARD_SITE_ID);
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/main_banner.php", array("NL_MAIN_SLIDER_IBLOCK_ID" => $iblockID));
?>