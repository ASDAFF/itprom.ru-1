...
COption::SetOptionString("bitlate.toolsshop", "NL_NEWS_ID", $iblockID, false, WIZARD_SITE_ID);
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/news_advantages_brands.php", array("NL_NEWS_IBLOCK_ID" => $iblockID));
