...
if($this->StartResultCache(false, array($arrFilter, ($arParams["CACHE_GROUPS"]==="N"? false: $USER->GetGroups()))))
{
	...
	************************************/
	...
	$arrFilterLeader = array(
		"PROPERTY_SALELEADER" => 18
	);
	$arrFilterNew = array(
		"PROPERTY_NEWPRODUCT" => 17
	);
	$arrFilterOffer = array(
		"PROPERTY_SPECIALOFFER" => 19
	);

	$rsElements = CIBlockElement::GetList($arSort, array_merge($arrFilter, $arrFilterLeader), false, array("nTopCount" => $arParams["ELEMENT_COUNT"]), $arSelect);
	...
	$rsElements = CIBlockElement::GetList($arSort, array_merge($arrFilter, $arrFilterNew), false, array("nTopCount" => $arParams["ELEMENT_COUNT"]), $arSelect);
	$rsElements->SetUrlTemplates($arParams["DETAIL_URL"]);
	...
	$rsElements = CIBlockElement::GetList($arSort, array_merge($arrFilter, $arrFilterOffer), false, array("nTopCount" => $arParams["ELEMENT_COUNT"]), $arSelect);
	$rsElements->SetUrlTemplates($arParams["DETAIL_URL"]);
