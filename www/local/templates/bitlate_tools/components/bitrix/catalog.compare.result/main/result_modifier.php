...
if (stripos($arResult['COMPARE_URL_TEMPLATE'], '?' . $arParams['ACTION_VARIABLE']) === false && stripos($arResult['COMPARE_URL_TEMPLATE'], '&' . $arParams['ACTION_VARIABLE']) === false) {
    $arResult['COMPARE_URL_TEMPLATE'] .= $arParams['ACTION_VARIABLE'];
}
?>