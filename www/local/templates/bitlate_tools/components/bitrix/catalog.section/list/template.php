            ...
            <div class="column large-6 xxlarge-8 column-info">
                ...
                <div class="row">
                    ...
                    <?if ($arParams['SHOW_MAX_QUANTITY']):
                        if (!isset($arItem['OFFERS']) || empty($arItem['OFFERS'])):
                            ...
                            if(empty($arItem["PROPERTIES"]["AVAILABILITY"]["VALUE"]))
                                $arItem["PROPERTIES"]["AVAILABILITY"]["VALUE"] = "В наличии";

                            ?>
                            <div class="column column-info-block small-6 medium-4 large-6 xxlarge-4 existence <?//=$quantityInfo['class']?>" title="<?=$quantityText?>" style="color:green">
                                <div class="existence-icon">
                                    <div class="existence-icon-active"></div>
                                </div>
                                <span class="existence-count"><?=$arItem["PROPERTIES"]["AVAILABILITY"]["VALUE"];?></span>
                            </div>
                        <?else:?>
                            <div class="column column-info-block small-6 medium-4 large-6 xxlarge-4">
                ...
                <div class="show-for-xxlarge">
                    <?if ('' != $arItem['PREVIEW_TEXT']):?>
                        <p class="description"><?=html_entity_decode($arItem['PREVIEW_TEXT'])?></p>
                    <?endif;?>
                    <?$isParams = false;
