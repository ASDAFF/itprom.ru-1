        ...
        <div class="item column text-center hover-elements"<?if ($arParams["TEMPLATE_THEME"] == 'slider'):?> id="<? echo $strMainID; ?>"<?endif;?>>
            ...
            <div class="hover-show bx_catalog_item_controls">
                <div class="hover-buttons">
                    ...
                    <a href="#" rel="nofollow" data-href="<? echo $arItem['DETAIL_PAGE_URL']; ?>?load=Y" id="<? echo $arItemIDs['PREVIEW_LINK']; ?>" class="button secondary tiny preview-button"><?=GetMessage('CT_BCS_PREVIEW')?></a>
                </div>
                    ...
                    <?if ($arItem['CAN_BUY']) {?>
                        <div class="row row-count-cart">
                            ...
                            <div id="<? echo $arItemIDs['BASKET_ACTIONS']; ?>" class="small-6 columns">
                                <a rel="nofollow" id="<? echo $arItemIDs['BUY_LINK']; ?>" href="javascript:;" class="button tiny add2cart" data-preview="#<? echo $arItemIDs['PICT']; ?>" data-product-id="<?=$arItem['ID']?>"><span><?=$buttonText?></span></a>
                            </div>
                        </div>
                    <?} else {?>
                    ...
                    <div class="bx_catalog_item_scu" id="<? echo $arItemIDs['PROP_DIV']; ?>">
                        ...
                        <div class="row row-count-cart bx_catalog_item_controls no_touch">
                            ...
                            <div id="<? echo $arItemIDs['BASKET_ACTIONS']; ?>" class="small-6 columns" style="display: <? echo ($canBuy ? '' : 'none'); ?>;">
                                <?foreach ($arItem['OFFERS'] as $key => $arOffer):
                                    $strVisible = ($key == $arItem['OFFERS_SELECTED'] ? '' : 'none');?>
                                    <a rel="nofollow" id="<? echo $arItemIDs['BUY_LINK']; ?><?=$arOffer['ID']?>" class="button tiny add2cart" href="javascript:;" rel="nofollow" data-preview="#<? echo $arItemIDs['PICT']; ?>" style="display: <? echo $strVisible; ?>;" data-product-id="<?=$arOffer['ID']?>"><span><?=$buttonText?></span></a>
                                <?endforeach;?>
                            </div>
                        </div>
