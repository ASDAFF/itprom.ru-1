<?
$MESS["REVIEWS"] = "Отзывы";
$MESS["REVIEW_BUTTON"] = "Оставить отзыв";
$MESS["REVIEWS_EMPTY"] = "Нет отзывов";
$MESS["B_B_MS_FROM"] = "от";
$MESS["B_B_MS_REPLY"] = "Ответить";
$MESS["B_B_MS_PARENT"] = "Родитель";
$MESS["B_B_MS_LINK"] = "Ссылка";
$MESS["B_B_MS_NAME"] = "Ваше имя";
$MESS["B_B_MS_CAPTCHA_SYM"] = "Введите код защиты от автоматических сообщений (символы на картинке)";
...
$MESS["FORM_TITLE"] = "Оставить отзыв";
$MESS["B_B_MS_CAPTCHA_SYM"] = "Код подтверждения (символы на картинке)";
$MESS["MESS_PREMODERATE"] = "Отзыв добавлен. После прохождения модерации он появится на сайте.";
$MESS["MESS_SUCCESS"] = "Отзыв добавлен";
$MESS["LABEL_RATING"] = "Ваша оценка:";
$MESS["BLOG_USER_NAME"] = "Фамилия, Имя";
$MESS["COMMENT"] = "Ваш отзыв";
$MESS["DOWNLOAD_PHOTO"] = "Загрузить фото";
$MESS["BUTTON_SEND"] = "Отправить";
$MESS["FORM_ERROR"] = "Произошла ошибка, попробуйте позже";
?>