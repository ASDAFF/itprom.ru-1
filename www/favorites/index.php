...
$APPLICATION->SetPageProperty("description", "Товары добавлены в избранное на сайте компании ITProm");
$APPLICATION->SetPageProperty("keywords", "Избранное ITProm");
$APPLICATION->SetPageProperty("title", "Избранное | Компания ITProm");
$APPLICATION->SetTitle("Избранное | Компания ITProm");
?>
<div class="wrapper">
  <div class="container">
