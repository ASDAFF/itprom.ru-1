...
<ul class="inner-content-list row large-up-2">
    <li class="inner-content-delivery columns table-container">
        <div class="preview table-item vertical-top">
            <img src="/local/templates/bitlate_tools/images/delivery-russianpost.jpg" alt="">
        </div>
    ...
    <li class="inner-content-delivery columns table-container">
        <div class="preview table-item vertical-top">
            <img src="/local/templates/bitlate_tools/images/delivery-ems.jpg" alt="">
        </div>
        <div class="table-item">
    ...
    <li class="inner-content-delivery columns table-container">
        <div class="preview table-item vertical-top">
            <img src="/local/templates/bitlate_tools/images/delivery-spsr.jpg" alt="">
        </div>
        <div class="table-item">
    ...
    <li class="inner-content-delivery columns table-container">
        <div class="preview table-item vertical-top">
            <img src="/local/templates/bitlate_tools/images/delivery-dhl.jpg" alt="">
        </div>
        <div class="table-item">
    ...
    <li class="inner-content-delivery columns table-container">
        <div class="preview table-item vertical-top">
            <img src="/local/templates/bitlate_tools/images/delivery-ups.jpg" alt="">
        </div>
        <div class="table-item">
    ...
    <li class="inner-content-delivery columns table-container">
        <div class="preview table-item vertical-top">
            <img src="/local/templates/bitlate_tools/images/delivery-pony-express.jpg" alt="">
        </div>
        <div class="table-item">
